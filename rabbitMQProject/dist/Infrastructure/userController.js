...
const userMapper_1 = require("./typeORM_sqlite/userMapper");
let userController = class userController {
    ...
    index(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const mappedUser = userMapper_1.UserMapper.mapToCore(data);
            const user = yield this.userService.createUser(mappedUser);
            return "reached";
        });
    }
    getUser(id, req, res) {
...
userController = __decorate([
    ...
    __param(0, (0, inversify_1.inject)(types_1.UserTypes.userService)),
